...
public sealed class ModemsViewModel : ObservableObject
{
    ...
    public ObservableCollection<ModemListItem> Items { get; } = new();
    ...
    public async Task LoadAsync()
    {
        ...
        try
        {
            var result = await _apiClient.GetModemsAsync(Search, Page, PageSize);
            ApplyResult(result);
        }
    ...
    private void ApplyResult(PagedResult<ModemListItem> result)
    {
        Items.Clear();
